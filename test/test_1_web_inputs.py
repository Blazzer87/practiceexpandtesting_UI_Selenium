...
class Test1WebInputs(BaseTest):
    ...
    def test1_web_inputs(self, number, text, password, date):
        ...
        self.web_input.click_input_and_send_keys(locator = self.web_input.input_number, text = number)
        self.web_input.click_input_and_send_keys(locator = self.web_input.input_text, text = text)
        self.web_input.click_input_and_send_keys(locator = self.web_input.input_password, text = password)
        self.web_input.click_input_and_send_keys(locator = self.web_input.input_date, text = date)
